          ...
          <div class="card shadow-2-strong" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center">
              ...
              <form action="" method="post">
                ...
                <a href="register.php" class="btn btn-primary btn-lg btn-block w-100 mt-3">Đăng ký</a>
                <a class="text-decoration-none text-black float-start mt-3" href="forgot.php">Quên mật khẩu</a>
                <hr class="my-5 mb-3">
