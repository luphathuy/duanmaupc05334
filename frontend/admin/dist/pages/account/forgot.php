...
if (isset($_POST['submit_manager'])) {
  ...
  if (empty($resetPass)) {
    ...
    $send = '<div><p><b>Xin chào!</b></p>
    <p>Bạn nhận được email này vì chúng tôi đã nhận được yêu cầu đặt lại mật khẩu cho tài khoản của bạn.</p><br>
    <p><button class="btn btn-success"><a href="http://good-wine/admin/dist/pages/account/passwordreset.php">
    ...
    $mail->Password = "rtlx mjty lpud wmzr";
          ...
          <div class="card shadow-2-strong" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center bg-secondary bg-opacity-25">
              ...
              <form action="" method="post">
                ...
                <a href="/admin/index.php" class="btn btn-primary btn-lg btn-block mb-2">Trở lại</a>
                <input class="btn btn-dark btn-lg btn-block mb-2" name="submit_manager" type="submit" value="Tìm kiếm">
              </form>
            </div>
          </div>
        </div>
