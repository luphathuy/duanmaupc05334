...
<body id="page-top" class='content' onload="thongbaopopup()">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-black" id="mainNav">
    <div class="container">
      <a class="" href="./index.php?pages=home"><img src="assets/product/dist/assets/img/logo1.png" alt="logo" width="75" /></a>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
        Menu
        <i class="fas fa-bars ms-1"></i>
      </button>
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="align-items-md-center navbar-nav text-uppercase ms-auto py-lg-0">
          ...
          <li class="nav-item">
            <form class="d-flex nav-link position-relative align-items-center d-flex m-0 nav-link position-relative" role="search" action="" method="">
              <input class="form-control ps-5 rounded-5" type="search" id="search" name="search" aria-label="Search">
              <button class="bg-white rounded-5 border-0 position-absolute" type="submit"><i class="fa fa-search ms-1" style="font-size: 15px;"></i></button>
            </form>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#!" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              <img src="./assets/admin/uploaded_img/<?php echo $images ?>" class="rounded-5 border" alt="" width="40">
            </a>
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
              ...
              <li><a class="dropdown-item mb-2 <?php echo $css_control; ?>" href="/assets/admin/index.php">Quản trị webste</a></li>
            </ul>
          </li>
