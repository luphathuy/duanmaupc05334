            ...
            if (isset($user_id)) {
              foreach (getUserSession($user_id) as $getU) : ?>
                <div class="d-flex align-items-center justify-content-start ms-2 mb-4 mt-5">
                  <img class="rounded-circle shadow-1-strong me-3" src="./admin/uploaded_img/<?= $getU['image'] ?>" alt="avatar" width="50" height="50" />
              ...
              <div class="row">
                <div class="col">
                  <div class="d-flex flex-start mb-3">
                    <!-- Comment -->
                    <img class="rounded-circle shadow-1-strong mt-2 me-3" src="./admin/uploaded_img/<?= $getCmt['user_image'] ?>" alt="avatar" width="50" height="50" />
            ...
            <div class="portfolio-item border border-dark">
              <div class="position-relative">
                ...
                <a data-bs-toggle="modal" href="./index.php?pages=products&action=detail&detail=<?= $data['id']; ?>&category=<?= $data['category']; ?>" title="Xem chi tiết">
                  <img class="img-fluid mb-4" src="./admin/uploaded_img/<?= $data['image']; ?>" alt="Ảnh sản phẩm" />
